...
<div key={user._id} className={`flex items-center p-2 hover:bg-stone-900 rounded-full cursor-pointer ${isSelected? "bg-stone-900":""}`} onClick={()=>{setSelectedConversation(user);
