				...
				<ul className='flex flex-col gap-3 mt-4  '>
					<li className='flex justify-center md:justify-start'>
						...
						>
							...
							<span className='text-2xl font-extrabold  hidden md:block'>Home</span>
						</Link>
					</li>
					<li className='flex justify-center md:justify-start'>
						<Link
						...
						>
							...
							<span className='text-2xl font-extrabold hidden md:block'>Notifications</span>
						</Link>
					</li>
				...
				{data && (
					...
					>
						...
						<div className='flex justify-between flex-1'>
							...
							<BiLogOut className='w-5 h-5 cursor-pointer fill-primary' onClick={(e)=>{
								e.preventDefault();
								mutate();
							}}
							 />
